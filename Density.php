...
<script type='text/javascript'>
 var filename = "/WIND/WINDRANGE/WIND-DENSITYrange.root";
 JSROOT.OpenFile(filename, function(file) {
   file.ReadObject("grProtonDensityVSTime;1", function(obj) {
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
<center><h3 style="color:rgb(60, 128, 214);"><b>Proton Density</b></h3>
<?php
$line2 = $_GET["birthday"];
$line = $_GET["birthday2"];
...
<?php
$myfile2 = fopen("WIND/E.txt", "w") or die("Unable to open file!");
$line2 = $_GET["birthday"];
$line = $_GET["birthday2"];
...
function Tree(){
    ...
    var path = "SSNTree_" + month + "-" + now.getDate() + "-" +now.getFullYear() + ".root";
...
<button><type="button"><a href="WIND/WINDRANGE/WIND-DENSITYrange.root">ROOT File</a></button>
</center>
